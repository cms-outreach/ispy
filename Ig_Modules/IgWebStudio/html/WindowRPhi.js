window.WindowRPhi = function (state, parent, id, title)
{
...
WindowRPhi = window.WindowRPhi;
importClass ("Studio.Window")
WindowRPhi.inherits (Window);

WindowRPhi.method ('init', function (state, parent, id, title) {
	this.uber ('init', state, parent, id, title, "WindowRPhi.prototype.onloadCallback (this, '" + id + "')");

    importClass ("Studio.BrowserRPhi")
    this.browser = 	new BrowserRPhi (this, id, 156, 156);
...
WindowRPhi.method ('onloadCallback', function (placeHolder, id) {
...
WindowRPhi.method ('onFocusIn', function (state) {
...
WindowRPhi.method ('onFocusOut', function (state) {
	var toolbar = state.lookup ("Toolbars/Toolbar3D");

#ifndef IG_RSS_CONFIG_H
# define IG_RSS_CONFIG_H
...
/** @def IG_RSS_BUILD_ARCHIVE
  @brief Indicates that this library is or was built as an archive
         ...
         #IG_RSS_API should be imported.  */

# ifndef IG_RSS_API
#  ifdef _WIN32
#    if defined IG_RSS_BUILD_DLL
#      define IG_RSS_API __declspec(dllexport)
#    elif ! defined IG_RSS_BUILD_ARCHIVE
#      define IG_RSS_API __declspec(dllimport)
#    endif
#  endif
# endif

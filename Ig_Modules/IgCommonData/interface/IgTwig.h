#ifndef IG_COMMON_DATA_IG_TWIG_H
# define IG_COMMON_DATA_IG_TWIG_H
...
class IG_COMMON_DATA_API IgTwig : public IgRepresentable
{
public:
...
class IG_COMMON_DATA_API IgCompoundTwig : public IgTwig
{
public:
...
class IG_COMMON_DATA_API IgSimpleTwig : public IgCompoundTwig
{
public:
    explicit
...
#endif // IG_COMMON_DATA_IG_TWIG_H

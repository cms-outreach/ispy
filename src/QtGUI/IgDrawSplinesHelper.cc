...
void
IgDrawSplinesHelper::create(SoGroup *sep, SoMFVec3f &points, SoMFVec3f &tangents)
{
  int npts = points.getNum();
  // For the moment we add 1 SoCoordinate4 and one SoNurbsCurve per spline.
  // At some point we can probably improve things by storing just one
  // SoCoordinate4
...
void
IgDrawSplinesHelper::midpoint(const SbVec3f pa, const SbVec3f pb,

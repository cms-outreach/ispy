...
{
  // VS complains about std::make_pair usage:
  // C:\Program Files\Microsoft Visual Studio 10.0\VC\include\type_traits(197): error C2752: 'std::tr1::_Remove_reference<_Ty>' : more than one partial specialization matches the template argument list
  // std::make_pair was replaced with std::pair

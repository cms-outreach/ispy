...
IViewBasicClusterTwig::IViewBasicClusterTwig (IgState *state, IgTwig *parent, 
					      const std::string &name)
    : IViewQueuedTwig (state, parent, name)
{}

void
IViewBasicClusterTwig::onNewEvent (IViewEventMessage& message) 
{
	...
	{	    
	    IgCollection &digis = storage->getCollection ("BasicClusters_V1");

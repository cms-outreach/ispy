...
namespace 
{
	...
	IViewReadService* readService = IViewReadService::get (state);
	ASSERT (readService);
...
{
    IgDrawFactroyService *drawService = IgDrawFactroyService::get (state);
    if (! drawService)
    {
        drawService = new IgDrawFactroyService (state);
    }

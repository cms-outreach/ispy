...
IViewCSCSegmentTwig::IViewCSCSegmentTwig (IgState *state, IgTwig *parent, 
					  const std::string &name)
    : IViewQueuedTwig (state, parent, name)
{}

void
IViewCSCSegmentTwig::onNewEvent (IViewEventMessage& message) 
{
	...
	sep->setName (SbName ("IViewCSCSegmentTwig"));

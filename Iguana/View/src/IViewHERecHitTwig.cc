...
IViewHERecHitTwig::IViewHERecHitTwig (IgState *state, IgTwig *parent, 
				      const std::string &name)
    : IViewQueuedTwig (state, parent, name)
{}

void
IViewHERecHitTwig::onNewEvent (IViewEventMessage& message) 
{
	...
	sep->setName (SbName ("IViewHERecHitTwig"));

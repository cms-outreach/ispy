...
IViewHORecHitTwig::IViewHORecHitTwig (IgState *state, IgTwig *parent, 
				      const std::string &name)
    : IViewQueuedTwig (state, parent, name)
{}

void
IViewHORecHitTwig::onNewEvent (IViewEventMessage& message) 
{
	...
	sep->setName (SbName ("IViewHORecHitTwig"));

...
IViewSiStripClusterTwig::IViewSiStripClusterTwig (IgState *state, IgTwig *parent, 
						  const std::string &name)
    : IViewQueuedTwig (state, parent, name)
{}

void
IViewSiStripClusterTwig::onNewEvent (IViewEventMessage& message) 
{    
	...
	if (storage->hasCollection ("SiStripClusters_V1"))
	{	    
		...
		sep->setName (SbName ("SiStripClusters_V1"));

...
class IViewQueuedTwig : public IgSimpleTwig, public IViewObserver
{
public:
    IViewQueuedTwig (IgState *state, IgTwig *parent, const std::string &name = "");

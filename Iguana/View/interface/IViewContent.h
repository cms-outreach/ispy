...
class IGUANA_FRAMEWORK_API IViewContent : public IgExtension
{
public:
    enum Type { MAIN_THREAD, EVENT_THREAD };
    IViewContent (IgState *state, IgStateKey key, Type which, lat::Callback action);
    IViewContent (IgState *state, IgStateKey key,

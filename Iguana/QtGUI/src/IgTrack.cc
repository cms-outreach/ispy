...
IgTrack::IgTrack (const vector<QPointF>& points, const vector<QPointF>& tangents /*= vector<QPointF>(0)*/,
		  /*const QPointF& position = QPointF (0., 0.),*/ const unsigned algo /*= AUTOMATIC*/, ISpyItem* parent /*= 0*/) 
    : ISpyItem            (parent),
      m_points            (points),
      m_tangents          (tangents),
      m_showPoints        (true),
...
IgTrack::IgTrack (const vector<QPointF>& points, const unsigned algo /*= AUTOMATIC*/, ISpyItem* parent /*= 0*/) :
    ISpyItem            (parent),
    m_points            (points),
    m_showPoints        (true),
    m_showInterpolation (true),

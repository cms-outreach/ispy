...
#include "Iguana/Iggi/interface/IggiControlCenter.h"
#include "Iguana/Iggi/interface/IgPolarCSControl.h"
...
IggiControlCenter::IggiControlCenter (QWidget* parent /*= 0*/)
    : QTabWidget (parent)
{
	ui.setupUi (this);
...
void
IggiControlCenter::setControlledItem (const unsigned controllerIndex, IggiItem* item)
{
...
void 
IggiControlCenter::closeEvent (QCloseEvent *event)
{
	emit isShown (false);
	event->accept();
}
...
void
IggiControlCenter::addController (IggiController* controller)
{

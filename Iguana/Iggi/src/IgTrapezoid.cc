...
#include "Iguana/Iggi/interface/IgTrapezoid.h"
#include <iostream>
...
IgTrapezoid::IgTrapezoid (float upperSide, float lowerSide, float height, const QPointF& center /*= QPointF (0., 0.)*/, IggiItem* parent /*= 0*/) :
	IggiItem (parent),
	m_center (center),
	m_height (height),
	m_upper  (upperSide),

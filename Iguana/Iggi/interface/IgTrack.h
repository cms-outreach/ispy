...
class IgTrack : public IggiItem
{

public:
    IgTrack (const vector<QPointF>& points, const vector<QPointF>& tangents /*= vector<QPointF>(0)*/,
	     /*const QPointF& position = QPointF (0., 0.),*/ 
	     const unsigned algorithm = AUTOMATIC, IggiItem* parent  = 0);
    IgTrack (const vector<QPointF>& points, const unsigned algorithm = AUTOMATIC, IggiItem* parent  = 0);
    ~IgTrack (void);

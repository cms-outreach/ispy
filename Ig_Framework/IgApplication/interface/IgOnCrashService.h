#ifndef IG_APPLICATION_IG_ON_CRASH_SERVICE_H
# define IG_APPLICATION_IG_ON_CRASH_SERVICE_H
...
class IG_APPLICATION_API IgOnCrashService
{
public:
...
#endif // IG_APPLICATION_IG_ON_CRASH_SERVICE_H

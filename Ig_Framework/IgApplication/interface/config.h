#ifndef IG_APPLICATION_CONFIG_H
# define IG_APPLICATION_CONFIG_H
...
/** @def IG_APPLICATION_API
  @brief A macro that controls how entities of this shared library are
         ...
         exported if #IG_APPLICATION_BUILD_DLL is defined, imported
         if #IG_APPLICATION_BUILD_ARCHIVE is not defined, and left
	 alone if latter is defined (for an archive library build).  */

/** @def IG_APPLICATION_BUILD_DLL
...
/** @def IG_APPLICATION_BUILD_ARCHIVE
  @brief Indicates that this library is or was built as an archive
	 ...
	 #IG_APPLICATION_API should be imported.  */

# ifndef IG_APPLICATION_API
#  ifdef _WIN32
#   if defined IG_APPLICATION_BUILD_DLL
#    define IG_APPLICATION_API __declspec(dllexport)
#   elif ! defined IG_APPLICATION_BUILD_ARCHIVE
#    define IG_APPLICATION_API __declspec(dllimport)
#   endif
#  endif
# endif

# ifndef IG_APPLICATION_API
#  define IG_APPLICATION_API
# endif

#endif // IG_APPLICATION_CONFIG_H

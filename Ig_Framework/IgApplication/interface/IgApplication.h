#ifndef IG_APPLICATION_IG_APPLICATION_H
# define IG_APPLICATION_IG_APPLICATION_H
...
class IG_APPLICATION_API IgApplication
{
public:
    IgApplication (void);
...
#endif // IG_APPLICATION_IG_APPLICATION_H

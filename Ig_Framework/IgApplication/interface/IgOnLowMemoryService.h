#ifndef IG_APPLICATION_IG_ON_LOW_MEMORY_SERVICE_H
# define IG_APPLICATION_IG_ON_LOW_MEMORY_SERVICE_H
...
class IG_APPLICATION_API IgOnLowMemoryService
{
public:
...
#endif // IG_APPLICATION_IG_ON_LOW_MEMORY_SERVICE_H

#ifndef IG_OBJECT_BROWSER_IG_BROWSER_METHODS_H
# define IG_OBJECT_BROWSER_IG_BROWSER_METHODS_H
...
class IG_OBJECT_BROWSER_API IgBrowserMethods
{
public:
...
#endif // IG_OBJECT_BROWSER_IG_BROWSER_METHODS_H

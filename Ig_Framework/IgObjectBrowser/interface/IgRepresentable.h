#ifndef IG_OBJECT_BROWSER_IG_REPRESENTABLE_H
# define IG_OBJECT_BROWSER_IG_REPRESENTABLE_H
...
class IG_OBJECT_BROWSER_API IgRepresentable
{
public:
...
#endif // IG_OBJECT_BROWSER_IG_REPRESENTABLE_H

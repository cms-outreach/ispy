#ifndef IG_QT_CONFIG_H
# define IG_QT_CONFIG_H
...
/** @def IG_QT_API
  @brief A macro that controls how entities of this shared library are
         ...
         exported if #IG_QT_BUILD_DLL is defined, imported
         if #IG_QT_BUILD_ARCHIVE is not defined, and left
...
/** @def IG_QT_BUILD_DLL
  @brief Indicates that the header is included during the build of
	 ...
	 with #IG_QT_API should be exported.  */

/** @def IG_QT_BUILD_ARCHIVE
  @brief Indicates that this library is or was built as an archive
	 ...
	 #IG_QT_API should be imported.  */

# ifndef IG_QT_API
#  ifdef _WIN32
#   if defined IG_QT_BUILD_DLL
#    define IG_QT_API __declspec(dllexport)
#   elif ! defined IG_QT_BUILD_ARCHIVE
#    define IG_QT_API __declspec(dllimport)
#   endif
#  endif
# endif

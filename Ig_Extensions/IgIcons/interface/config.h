#ifndef IG_EXTENSIONS_CONFIG_H
# define IG_EXTENSIONS_CONFIG_H
...
/** @def IG_ICONS_API
    ...
    exported if #IG_ICONS_BUILD_DLL is defined, imported
    if #IG_ICONS_BUILD_ARCHIVE is not defined, and left
    alone if latter is defined (for an archive library build).  */

/** @def IG_ICONS_BUILD_DLL
    @brief Indicates that the header is included during the build of
    a shared library of this package, and all entities marked
    with #IG_ICONS_API should be exported.  */

/** @def IG_ICONS_BUILD_ARCHIVE
    ...
    #IG_ICONS_API should be imported.  */

# ifndef IG_ICONS_API
#  ifdef _WIN32
#   if defined IG_ICONS_BUILD_DLL
#    define IG_ICONS_API __declspec(dllexport)
#   elif ! defined IG_ICONS_BUILD_ARCHIVE
#    define IG_ICONS_API __declspec(dllimport)
#   endif
#  endif
# endif

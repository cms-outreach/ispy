...
IgSoTower::IgSoTower (void)
{
    ...
    orderedRGBA.set1Value (1, SbColor (0.622, 0.0, 0.622).getPackedValue ());
    orderedRGBA.set1Value (2, SbColor (0.622, 0.0, 0.622).getPackedValue ());
    orderedRGBA.set1Value (3, SbColor (0.622, 0.0, 0.622).getPackedValue ());
    orderedRGBA.set1Value (4, SbColor (0.622, 0.0, 0.622).getPackedValue ());
    orderedRGBA.set1Value (5, SbColor (0.622, 0.0, 0.622).getPackedValue ());
    orderedRGBA.set1Value (6, SbColor (0.0, 0.0, 1.0).getPackedValue ());
    orderedRGBA.set1Value (7, SbColor (0.0, 0.0, 1.0).getPackedValue ());
    orderedRGBA.set1Value (8, SbColor (0.0, 0.0, 1.0).getPackedValue ());
    orderedRGBA.set1Value (9, SbColor (0.0, 0.0, 1.0).getPackedValue ());
    orderedRGBA.set1Value (10, SbColor (0.0, 0.0, 1.0).getPackedValue ());
    orderedRGBA.set1Value (11, SbColor (0.0, 0.0, 1.0).getPackedValue ());
...
IgSoTower::refresh (void)
{
    ...
    {
	orderedRGBA.set1Value (0, SbColor (0.0, 0.0, 1.0).getPackedValue ());
	orderedRGBA.set1Value (1, SbColor (0.0, 0.0, 1.0).getPackedValue ());
	orderedRGBA.set1Value (2, SbColor (0.0, 0.0, 1.0).getPackedValue ());
	orderedRGBA.set1Value (3, SbColor (0.0, 0.0, 1.0).getPackedValue ());
	orderedRGBA.set1Value (4, SbColor (0.0, 0.0, 1.0).getPackedValue ());
	orderedRGBA.set1Value (5, SbColor (0.0, 0.0, 1.0).getPackedValue ());
	vtx->orderedRGBA = orderedRGBA;
    ...
    {
	orderedRGBA.set1Value (6, SbColor (0.622, 0.0, 0.622).getPackedValue ());
	orderedRGBA.set1Value (7, SbColor (0.622, 0.0, 0.622).getPackedValue ());
	orderedRGBA.set1Value (8, SbColor (0.622, 0.0, 0.622).getPackedValue ());
	orderedRGBA.set1Value (9, SbColor (0.622, 0.0, 0.622).getPackedValue ());
	orderedRGBA.set1Value (10, SbColor (0.622, 0.0, 0.622).getPackedValue ());
	orderedRGBA.set1Value (11, SbColor (0.622, 0.0, 0.622).getPackedValue ());
	vtx->orderedRGBA = orderedRGBA;
